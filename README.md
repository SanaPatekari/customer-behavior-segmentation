...
Project Objective
Transform transaction-level data into customer-level behavioral features. Group customers with similar behavior patterns. Interpret and explore segments in an interactive way
...
Source: Kaggle
Link:  Credit Card Transactions Dataset
...
Personally identifiable fields are not used for analysis or visualization.The fraud label included in the dataset is not used in this project.
